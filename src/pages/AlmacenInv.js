...
const AlmacenInv = (props) => {
    ...
    useEffect(() => {
        if(props.dataUser.USSCO?.split(',').indexOf('totalwms_bodega_articulos_crear') !== -1 && props.dataUser.USSCO?.split(',').indexOf('totalwms_bodega_articulos_editar') === -1) {
            setRoutes([
                { key: 'find', title: 'Buscar\nProductos' }, 
                { key: 'manager', title: 'Agregar\nProductos' }, 
                { key: 'bodega', title: 'Buscar\npor QR' }
            ])
        } else if(props.dataUser.USSCO?.split(',').indexOf('totalwms_bodega_articulos_crear') !== -1 && props.dataUser.USSCO?.split(',').indexOf('totalwms_bodega_articulos_editar') !== -1) {
            setRoutes([
                { key: 'find', title: 'Buscar\nProductos' }, 
                { key: 'manager', title: 'Agregar\nProductos' }, 
